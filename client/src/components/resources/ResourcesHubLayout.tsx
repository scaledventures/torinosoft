...
type ResourcesHubLayoutProps = {
  title: string;
  whitepaper: { description: string; href: string };
  blog: { description: string; href: string };
};

export function ResourcesHubLayout({ title, whitepaper, blog }: ResourcesHubLayoutProps) {
  return (
        ...
        <section className="max-w-5xl mx-auto space-y-10">
          ...
          <div className="bg-card/40 border border-border rounded-3xl px-6 py-8 md:px-10 md:py-12 shadow-sm space-y-10">
            <div className="space-y-4">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">{whitepaper.description}</p>
              <Link href={whitepaper.href} className="inline-flex">
                <Button
                  size="sm"
            ...
            <div className="space-y-3">
              <h2 className="text-xl md:text-2xl font-heading font-semibold text-primary">Blog</h2>
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">{blog.description}</p>
